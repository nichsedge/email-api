...
class SecureEmailClient:
    ...
    def send_email(self, email_credentials: Dict[str, Any], receiver_email: str, 
        ...
        try:
            ...
            with smtplib.SMTP(email_credentials['smtp_server'], email_credentials['smtp_port']) as server:
                ...
                server.sendmail(email_credentials['email_address'], receiver_email, message.as_string())
    ...
    def get_unread_emails(self, email_credentials: Dict[str, Any], 
                         filter_by: str = "today", mark_as_read: bool = False) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            with imaplib.IMAP4_SSL(email_credentials['imap_server'], email_credentials['imap_port']) as mail:
    ...
    "timestamp": datetime.utcnow()                  # optional if you want it filled
                ...
                logger.info("Retrieved unread emails", 
    ...
    def mark_email_as_read(self, email_credentials: Dict[str, Any], email_id: str) -> Dict[str, Any]:
    ...
    def mark_emails_as_read_batch(self, email_credentials: Dict[str, Any], 
                                 email_ids: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            with imaplib.IMAP4_SSL(email_credentials['imap_server'], email_credentials['imap_port']) as mail:
                ...
                logger.info("Batch email read operation completed",
    ...
    def mark_emails_as_unread_batch(self, email_credentials: Dict[str, Any], 
                                   email_ids: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            with imaplib.IMAP4_SSL(email_credentials['imap_server'], email_credentials['imap_port']) as mail:
                ...
                logger.info("Batch email unread operation completed",
                           total_processed=len(email_ids),
                           success_count=success_count,
                           failure_count=failure_count)
    ...
    def _validate_credentials(self, credentials: Dict[str, Any]) -> bool:
        ...
        required_fields = ['email_address', 'smtp_server', 'smtp_port', 'imap_server', 'imap_port']
